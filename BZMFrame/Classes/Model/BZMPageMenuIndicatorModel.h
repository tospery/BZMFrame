 ...
 */
@interface BZMPageMenuIndicatorModel : BZMBaseModel
...
@property (nonatomic, assign) BZMPageMenuCellSelectedType selectedType;  //cell被选中类型
